        ...
        <div className="lg:col-span-3 space-y-6">
          <div>
            ...
            <input
              ...
              className="bg-[#0E1322] border border-gray-800 focus:border-neonOrange rounded-xl px-4 py-2.5 text-sm text-gray-200 outline-none w-full md:w-64 transition-colors"
            />
          </div>
